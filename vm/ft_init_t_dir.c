...
{
	//(*dir).bytes[0] = (position + 3 > (MEM_SIZE - 1) ?
	//map[position + 3 - MEM_SIZE][0] : map[position + 3][0]);
	...
	//(*dir).bytes[1] = (position + 2 > (MEM_SIZE - 1) ?
	//map[position + 2 - MEM_SIZE][0] : map[position + 2][0]);
	...
	//(*dir).bytes[2] = (position + 1 > (MEM_SIZE - 1) ?
	...
	//(*dir).bytes[3] = (position > (MEM_SIZE - 1) ?
